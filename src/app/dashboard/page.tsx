        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-zinc-900 pb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#7DD3FC] text-zinc-950 hover:bg-[#7DD3FC]/90 px-4 py-2.5 text-sm font-semibold shadow-lg shadow-[#7DD3FC]/10 transition hover:brightness-110 cursor-pointer"
            >
                          ...
                          return (
                            <tr key={item.id} className="hover:bg-zinc-900/10 transition">
                              <td className="py-4 pl-2 font-semibold text-white">
                                ...
                                <div className="text-[10px] text-zinc-550 font-normal mt-0.5">{item.user?.email}</div>
                              </td>
                              ...
                              <td className="py-4 font-bold text-[#7DD3FC]">
              ...
              {isCreating ? (
                ...
                <div className="py-12 flex flex-col items-center justify-center text-center space-y-6">
                  <div className="relative">
                    <div className="absolute inset-0 rounded-full bg-[#7DD3FC]/20 blur-xl animate-pulse" />
                    <Loader2 className="h-16 w-16 animate-spin text-[#7DD3FC] relative z-10" />
                  </div>
                ...
                <form onSubmit={handleStartInterview} className="space-y-6 flex-1 overflow-y-auto pr-1">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs font-bold text-[#7DD3FC]">{experience} Years</span>
                    </div>
                    <input
                      id="experience"
                      type="range"
                      ...
                      className="w-full h-1 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-[#7DD3FC]"
                    />
                  </div>
                  ...
                  <div className="flex justify-end gap-3 pt-4 border-t border-white/[0.08]">
                    ...
                    <button
                      type="submit"
                      className="inline-flex items-center gap-1.5 rounded-xl bg-[#7DD3FC] text-zinc-950 hover:bg-[#7DD3FC]/90 px-5 py-2.5 text-sm font-semibold shadow-lg shadow-[#7DD3FC]/10 transition hover:brightness-110 cursor-pointer"
                    >
