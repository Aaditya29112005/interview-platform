...
export default function InterviewStudioPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex flex-col justify-between bg-[#020305] overflow-hidden">
      ...
      <div className="absolute top-[10%] left-[-15%] h-[500px] w-[500px] rounded-full bg-[#7DD3FC]/5 blur-[120px]" />
      <div className="absolute bottom-[10%] right-[-15%] h-[500px] w-[500px] rounded-full bg-[#7DD3FC]/3 blur-[120px]" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex-1 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="space-y-6 flex flex-col justify-between">
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/10 p-6 backdrop-blur-sm space-y-6">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 space-y-3 shadow-lg shadow-[#7DD3FC]/2">
              <div className="flex items-center justify-between border-b border-zinc-900 pb-2">
                ...
                <span className="text-2xs font-semibold text-[#7DD3FC] bg-[#7DD3FC]/10 px-2 py-0.5 rounded">
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 space-y-3 shadow-lg shadow-[#7DD3FC]/2">
              <div className="flex items-center justify-between border-b border-zinc-900 pb-2">
                <span className="text-2xs font-bold text-zinc-500 uppercase tracking-widest flex items-center gap-1.5">
                  <Brain className="h-3.5 w-3.5 text-[#7DD3FC]" />
                  ...
                  <div key={skill} className="bg-zinc-900/25 border border-zinc-900/50 rounded-lg p-2 space-y-1">
                    ...
                    <div className="flex items-center gap-1">
                      <div className="flex-1 h-1 bg-zinc-800 rounded-full overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-[#7DD3FC] to-white rounded-full transition-all duration-500" 
                          style={{ width: `${val}%` }} 
                        />
                      </div>
                  ...
                  <div key={index} className="flex items-start gap-2.5">
                    <div className="mt-0.5">
                      {topic.status === 'completed' ? (
                        ...
                        <span className="block h-3.5 w-3.5 rounded-full bg-[#7DD3FC]/20 border border-[#7DD3FC] animate-pulse" />
                      ) : (
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/10 p-5 backdrop-blur-sm flex flex-col justify-between">
              <div className="border-b border-zinc-900 pb-2 flex items-center justify-between">
                <h3 className="text-xs font-bold text-white flex items-center gap-1.5">
                  <MessageSquare className="h-4 w-4 text-[#7DD3FC]" />
                  <span>Dialogue Transcript</span>
                </h3>
                <button 
                  onClick={() => setShowTranscript(!showTranscript)}
                  className="text-2xs text-[#7DD3FC] font-semibold hover:underline"
                >
                    ...
                    messages.map((msg, index) => (
                      <div key={index} className={msg.speaker === 'candidate' ? 'text-right' : 'text-left'}>
                        ...
                        <p className={`inline-block rounded-lg px-2.5 py-1.5 mt-0.5 text-zinc-300 ${
                          msg.speaker === 'candidate' ? 'bg-[#7DD3FC]/15 text-[#7DD3FC]' : 'bg-zinc-900/60'
                        }`}>{msg.text}</p>
                      </div>
                    ))
                  ) : (
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/10 p-5 backdrop-blur-sm flex flex-col justify-between min-h-[500px]">
          ...
          <div className="flex items-center justify-between border-b border-zinc-900 pb-4">
            <div className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[#7DD3FC] animate-pulse" />
            ...
            <div className="flex items-center gap-2.5">
              <select
                ...
                className="rounded-lg border border-zinc-800 bg-zinc-950 px-2.5 py-1 text-2xs text-zinc-350 outline-none focus:border-[#7DD3FC]"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-[#7DD3FC] px-3 py-1.5 text-2xs font-bold text-zinc-950 hover:bg-[#7DD3FC]/90 disabled:opacity-50 transition"
              >
                {isRunningCode ? (
                  <>
          ...
          <div className="flex items-center gap-3">
            {!isConnected ? (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#7DD3FC] px-5 py-3 text-sm font-semibold text-zinc-950 shadow-lg shadow-[#7DD3FC]/10 transition hover:brightness-110 cursor-pointer disabled:opacity-50"
              >
                {isConnecting ? (
                  <>
